...
recupData.trouverVal("S5AFA", "S5.A")
...
# fonction pour récupérer les valeurs du premier semestre dans le fichier planning
recupData.trouverVal("S6AFA", "S6.A")
# fonction pour vérifier les concordances entre le fichier planning et le fichier maquette nationnal à partir de
# la base de données pour le premier semestre
...
# fonction pour récupérer les valeurs du premier semestre dans le fichier planning
recupData.trouverVal("S5AFI", "S5.A")
# fonction pour vérifier les concordances entre le fichier planning et le fichier maquette nationnal à partir de
# la base de données pour le premier semestre
...
# fonction pour récupérer les valeurs du premier semestre dans le fichier planning
recupData.trouverVal("S6AFI", "S6.A")
# fonction pour vérifier les concordances entre le fichier planning et le fichier maquette nationnal à partir de
# la base de données pour le premier semestre
...
# fonction pour récupérer les valeurs du premier semestre dans le fichier planning
recupData.trouverVal("S5BFA", "S5.B")
# fonction pour vérifier les concordances entre le fichier planning et le fichier maquette nationnal à partir de
# la base de données pour le premier semestre
...
# fonction pour récupérer les valeurs du premier semestre dans le fichier planning
recupData.trouverVal("S6BFA", "S6.B")
# fonction pour vérifier les concordances entre le fichier planning et le fichier maquette nationnal à partir de
# la base de données pour le premier semestre
...
# fonction pour récupérer les valeurs du premier semestre dans le fichier planning
recupData.trouverVal("S5BFI", "S5.A")
# fonction pour vérifier les concordances entre le fichier planning et le fichier maquette nationnal à partir de
# la base de données pour le premier semestre
...
# fonction pour récupérer les valeurs du premier semestre dans le fichier planning
recupData.trouverVal("S6BFI", "S6.B")
# fonction pour vérifier les concordances entre le fichier planning et le fichier maquette nationnal à partir de
# la base de données pour le premier semestre
