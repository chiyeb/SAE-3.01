...
# Récupérer les cours par date dans le fichier planning
recupDataInstance.recupXetY("S4AFA", "S4.A")
# Vérifie la concordance entre les heures écrite et les heures placés dans le fichier planning
verifDataInstance.concordancePlanning("S4AFA")
...
# Récupérer les cours par date dans le fichier planning
recupDataInstance.recupXetY("S3AFI", "S3")
# Vérifie la concordance entre les heures écrite et les heures placés dans le fichier planning
verifDataInstance.concordancePlanning("S3AFI")
...
# Récupérer les cours par date dans le fichier planning
recupDataInstance.recupXetY("S4AFI", "S4.A")
# Vérifie la concordance entre les heures écrite et les heures placés dans le fichier planning
verifDataInstance.concordancePlanning("S4AFI")
...
# Récupérer les cours par date dans le fichier planning
recupDataInstance.recupXetY("S3BFA", "S3")
# Vérifie la concordance entre les heures écrite et les heures placés dans le fichier planning
verifDataInstance.concordancePlanning("S3BFA")
...
# Récupérer les cours par date dans le fichier planning
recupDataInstance.recupXetY("S4BFA", "S4.B")
# Vérifie la concordance entre les heures écrite et les heures placés dans le fichier planning
verifDataInstance.concordancePlanning("S4BFA")
...
# Récupérer les cours par date dans le fichier planning
recupDataInstance.recupXetY("S3BFI", "S3")
# Vérifie la concordance entre les heures écrite et les heures placés dans le fichier planning
verifDataInstance.concordancePlanning("S3BFI")
...
# Récupérer les cours par date dans le fichier planning
recupDataInstance.recupXetY("S4BFI", "S4.B")
# Vérifie la concordance entre les heures écrite et les heures placés dans le fichier planning
verifDataInstance.concordancePlanning("S4BFI")