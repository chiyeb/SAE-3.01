...
try:
    with sqlite3.connect("database/database.db") as conn:
        ...
        cursor.execute("SELECT DISTINCT Ressource FROM Planning WHERE Semestre = 'S2'")
        ...
        try:
            ...
            print("Le fichier S2.xlsx n'a pas été trouvé.")
            exit()
        ...
        for resource in resources:
            ...
            # Copier toutes les données de la feuille de base (Feuil1) dans la nouvelle feuille
